...
// ------ TITULO ---------------------
// Verificar actualización de cita con nuevo horario seleccionado
// A a cargo: Villarroel Balderrama Rocio Mirtha

//----DESCRIPCION -------
//El sistema debe actualizar la cita cuando el usuario seleccione un nuevo horario válido durante la reprogramación
