...
test.describe('TC - Flujo completo de QR caducado - Fixer Wallet', () => {

  test('Flujo de login, acceso al QR caducado', async ({ page }: { page: Page }) => {
    ...
    // Paso 9: Click en "Generar Codigo QR y se visualiza un contador de 5 minutos.. acabando los 5 minutos el QR caduca"
