...
test.describe('TC - Flujo completo de visualizar graficos de ingresos - Fixer Wallet', () => {

  test('Flujo de login, acceso Grafico de los ingresos', async ({ page }: { page: Page }) => {
    ...
    // Paso 7: Click en "Grafico de Ingresos"
    await page.getByRole('button', { name: 'Gráfico de Ingresos' }).click();
